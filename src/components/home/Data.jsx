...
const Data = () => {
    return (
       <div className="home__data">
            <h1 className="home__title">Fevin Patel
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">I help companies to develop innovative software solutions to achieve considerable business value.</p>
